...
- within your `.R` plotting script:
   ...
   - utilize the plot-saving function that you created earlier in order to save your plot as a `.png` file named meaningfully and ensuring that you save it to a `figs/` directory (needed for the `.png` embedding into the `.qmd` file)
...
[here](https://ln5.sync.com/dl/a038628f0/wwfifjxk-f7rfshin-rkedi3y8-77f9zaii)
